# Part 20 — Freeze Panes and Split View in Excel

## Overview
When working with large datasets that extend beyond the screen, keeping row and column headers visible is essential. Freeze Panes and Split View solve this — understanding both prevents the most common large-spreadsheet frustration.

## Freeze Panes

### Freeze the Top Row
**View -> Freeze Panes -> Freeze Top Row**
Row 1 (your header row) stays fixed as you scroll down. All other rows scroll normally.

### Freeze the First Column
**View -> Freeze Panes -> Freeze First Column**
Column A stays visible as you scroll right.

### Freeze Both a Row AND a Column Simultaneously
This is the most useful setting for large data tables with both row and column headers.
1. Click the cell that is **below** the rows you want frozen AND **to the right** of the columns you want frozen
   - Example: to freeze Row 1 and Column A, click cell **B2**
   - Example: to freeze Rows 1-2 and Column A, click cell **B3**
...
## Split View
**View -> Split**
Divides the Excel window into 2 or 4 independent panes at the active cell position.
Each pane scrolls independently.
Good for: comparing data from different parts of the same sheet.

## Freeze Panes vs Split View Comparison
| Feature | Freeze Panes | Split View |
|---|---|---|
| Headers always visible | Yes | No (independent scroll per pane) |
| Compare two distant areas | No | Yes |
| Typical use | Large data entry with headers | Comparing top/bottom of same dataset |
| Number of panes | 1 (with frozen section) | 2 or 4 |

## The Greyed-Out Problem — Fix
**Problem**: The Freeze Panes option is greyed out and cannot be clicked.
**Cause**: The sheet is in Page Break Preview mode or Print Preview.
**Fix**: View -> **Normal** -> then apply Freeze Panes.

## Resources
- Watch: https://www.youtube.com/watch?v=oWLxe43M3h8
