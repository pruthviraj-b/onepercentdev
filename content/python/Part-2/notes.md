# Part 2 — Data Types (int, float, complex, bool, str, None)

## Topic Overview

**Data Types (int, float, complex, bool, str, None)** is a focused lesson in core Python. We will learn the operation, build a mental model, trace a small example, examine failure modes, and connect the technique to a real analytical decision.
...
- Define **Data Types (int, float, complex, bool, str, None)** in precise technical language.
...
Analysts rarely fail because they cannot remember a method name. They fail when a technically valid operation answers the wrong question, silently drops records, changes the data grain, or hides an assumption. **Data Types (int, float, complex, bool, str, None)** matters because it gives you a controlled way to solve a recurring problem in core Python.

## Definitions

**Data Types (int, float, complex, bool, str, None)**: a Python/data-analysis technique used to express a specific transformation, inspection, calculation, or communication step. Its correctness depends on both its syntax and the meaning of its input.
...
```text
┌──────────────┐    ┌────────────────┐    ┌──────────────┐
│ input data   │ →  │ Data Types (int, float, complex, bool, str, None)        │ →  │ result       │
...
3. Apply Data Types (int, float, complex, bool, str, None)
...
- Applying **Data Types (int, float, complex, bool, str, None)** before confirming the input's type or grain.
...
1. What problem does **Data Types (int, float, complex, bool, str, None)** solve?
...
1. Explain **Data Types (int, float, complex, bool, str, None)** to a junior analyst using a small example.
...
**Data Types (int, float, complex, bool, str, None)** is valuable when it is used deliberately: define the question, establish the input contract, apply the operation, inspect the output, validate the important invariants, and communicate the result with its assumptions. Syntax starts the work; reasoning and verification finish it.

## Revision Checklist

- [ ] I can define **Data Types (int, float, complex, bool, str, None)** without copying a sentence.
