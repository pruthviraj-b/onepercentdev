...
content = """# 1.0.2 Data types — SQL Data Types (Data Analyst Edition)
...
# 1. Save content/sql/Part-2/notes.md
part_dir = os.path.join('content', 'sql', 'Part-2')
os.makedirs(part_dir, exist_ok=True)
notes_file = os.path.join(part_dir, 'notes.md')
with open(notes_file, 'w', encoding='utf-8') as f:
    f.write(content)

# 2. Update modules-sql.json & notes/sql/2.json in public/api
...
with open(os.path.join(sql_notes_dir, '2.json'), 'w', encoding='utf-8') as f:
    json.dump({
        'part': 2,
        'title': '1.0.2 Data types',
        'notes': content,
        'files': [],
        'importance': 'high',
