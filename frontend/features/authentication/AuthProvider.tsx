...
import { auth, isFirebaseConfigured } from '@/services/authService';
import { syncUserProfile, markOffline } from '@/services/analyticsService';
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    let unsubscribe = () => {};
    // Firebase can remain pending indefinitely when the auth service is
    // unreachable. Do not leave the entire application on the boot screen.
