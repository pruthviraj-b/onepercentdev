  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .token-comment { color: #555555; font-style: italic; }
      .token-keyword { color: #000000; font-weight: bold; text-decoration: underline; }
      .token-string { color: #000000; font-style: italic; }
      .token-number { color: #000000; font-weight: bold; }
      ...
      .export-table tr:nth-child(even) td { background: #fafafa; }
