...
function CompletionAnimation({ onDone }: { onDone: () => void }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ color: '#f1be3e', fontFamily: 'var(--font-ui)', fontWeight: 900, fontSize: '1.2rem', marginTop: 12, textTransform: 'uppercase', letterSpacing: '0.06em' }}>
        Lesson Complete!
      </div>
...
function ResumeDialog({ savedAt, onResume, onStartOver }: {
  ...
  return (
    <div style={{
      ...
      <div style={{ background: '#fff', border: '3px solid #000', boxShadow: '8px 8px 0 #000', padding: '24px 28px', maxWidth: 300, width: '90%', textAlign: 'center', fontFamily: 'var(--font-ui)' }}>
        <div style={{ fontSize: '1.5rem', marginBottom: 10 }}>▶</div>
        <div style={{ fontWeight: 900, fontSize: '0.95rem', marginBottom: 6, textTransform: 'uppercase' }}>Continue watching?</div>
        <div style={{ fontSize: '0.82rem', color: '#555', marginBottom: 18 }}>
          You left off at <strong>{formatSeconds(savedAt)}</strong>
        </div>
        <div style={{ display: 'flex', gap: 8 }}>
          <button onClick={onResume}
            style={{ flex: 1, padding: '10px', background: '#000', color: '#f1be3e', border: '2px solid #000', fontFamily: 'var(--font-ui)', fontWeight: 900, fontSize: '0.8rem', cursor: 'pointer', textTransform: 'uppercase' }}>
            Resume
          </button>
          <button onClick={onStartOver}
            style={{ flex: 1, padding: '10px', background: '#fff', color: '#000', border: '2px solid #000', fontFamily: 'var(--font-ui)', fontWeight: 700, fontSize: '0.8rem', cursor: 'pointer', textTransform: 'uppercase' }}>
            Start Over
          </button>
        </div>
      </div>
  ...
  return (
    <div style={{ position: 'relative', width: '100%', paddingBottom: '56.25%', height: 0, background: '#000' }}>
      ...
      {alreadyCompleted && !showCompletion && (
        <div style={{
          position: 'absolute', top: 8, right: 8, background: '#2ecc71', color: '#fff',
