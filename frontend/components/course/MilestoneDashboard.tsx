...
export function MilestoneDashboard({ courseId, modules, completedParts, progressPct }: { courseId: string; modules: Module[]; completedParts: number[]; progressPct: number }) {
  ...
  return <section className="milestone-dashboard" aria-label="Milestone journey">
    <div className="milestone-dashboard-hero"><div><span className="milestone-dashboard-eyebrow">MILESTONE JOURNEY</span><h2>Build your proof of progress.</h2><p>Five verified achievements that turn lessons into a portfolio story.</p></div><div className="milestone-dashboard-ring"><strong>{progressPct}%</strong><span>course</span></div></div>
