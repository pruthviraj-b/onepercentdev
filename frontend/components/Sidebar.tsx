...
export function Sidebar({
  ...
  return (
    <aside className="sidebar" aria-label="Course navigation" style={{ background: '#f4f1ea', borderLeft: '2px solid #2a2410' }}>
      {/* Search */}
      ...
      <div className="sidebar-progress">
        ...
        >
          <div className="progress-fill" style={{ width: `${progressPct}%`, background: '#2a2410' }} />
        </div>
      </div>
...
function PartItem(props: { note: PartMeta; active: boolean; done: boolean; bookmarked: boolean; onSelect: (part: number) => void }) {
  const { note, active, done, bookmarked, onSelect } = props;
