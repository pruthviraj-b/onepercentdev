...
export function AptitudeView({ onBack }: AptitudeViewProps) {
  ...
  if (phase === 'roadmap') return wrap(
    <>
      ...
      <div style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: '10px', padding: '16px 20px', marginBottom: '24px', fontSize: '0.86rem', lineHeight: 1.7, color: C.textDim }}>
      ...
      {ROADMAP_TIERS.map(tier => (
        <div key={tier.id} style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: '10px', overflow: 'hidden', marginBottom: '14px' }}>
          <div style={{ background: C.surfaceHi, borderBottom: `1px solid ${C.border}`, borderLeft: `3px solid ${tier.accent}`, padding: '12px 18px' }}>
      ...
      <div style={{ background: C.surfaceHi, border: `1px solid ${C.borderHi}`, borderRadius: '10px', padding: '16px 20px', margin: '24px 0', fontSize: '0.85rem', color: C.textDim, lineHeight: 1.6 }}>
  ...
  if (phase === 'menu') return wrap(
    <>
      ...
      <div style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: '10px', overflow: 'hidden', marginBottom: '24px' }}>
        <div style={{ background: C.surfaceHi, borderBottom: `1px solid ${C.border}`, padding: '12px 20px', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.05em', color: C.text, fontSize: '0.85rem' }}>
          Choose Category
        </div>
        ...
        <div style={{ padding: '0 24px 24px' }}>
          <div style={{ background: C.surfaceHi, border: `1px solid ${C.border}`, borderRadius: '8px', padding: '14px', marginBottom: '20px', fontSize: '0.88rem', lineHeight: 1.6, color: C.textDim }}>
    ...
    return wrap(
      <>
        ...
        <div style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: '10px', overflow: 'hidden', marginBottom: '16px' }}>
          <div style={{ padding: '24px 24px 20px', fontSize: '1.05rem', fontWeight: 700, lineHeight: 1.6, fontFamily: 'var(--font-content)', borderBottom: `1px solid ${C.border}`, color: C.text }}>
          ...
          {selected !== null && (
            <div style={{ background: C.violetDim, borderTop: `1px solid ${C.border}`, padding: '14px 24px', fontSize: '0.88rem', lineHeight: 1.6, fontFamily: 'var(--font-content)', color: C.text }}>
  ...
  return wrap(
    <>
      <div style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: '12px', overflow: 'hidden', marginBottom: '24px' }}>
        <div style={{ background: C.surfaceHi, borderBottom: `1px solid ${C.border}`, padding: '16px 24px', textAlign: 'center' }}>
        ...
        <div style={{ padding: '28px', display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '16px', textAlign: 'center' }}>
          {[
            ...
            <div key={s.label} style={{ border: `1px solid ${C.border}`, borderRadius: '8px', padding: '16px', background: C.surfaceHi }}>
      ...
      {questions.map((q, i) => {
        ...
        return (
          <div key={q.id} style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: '8px', marginBottom: '8px', overflow: 'hidden' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '10px 16px', borderBottom: `1px solid ${C.border}`, background: correct ? C.greenDim : 'rgba(240,113,108,0.14)' }}>
