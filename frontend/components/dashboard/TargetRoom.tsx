...
import { fetchModules, fetchProgress } from '@/services/courseService';
...
export function TargetRoom({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div className="target-room-page" style={{ minHeight: '100vh', background: C.bg, color: C.text, fontFamily: F.body }}>
      <style>{`
* { box-sizing: border-box; }
      ...
      {/* Header */}
      <header className="target-room-header" style={{
      ...
      {/* Status Strip */}
      <div className="target-room-status" style={{
      ...
      {/* Main Content */}
      <main className="target-room-main" style={{ padding: '24px', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <section className="target-room-section" style={{ marginBottom: '32px' }}>
        ...
        <section className="target-room-section" style={{ marginBottom: '32px' }}>
          ...
          <div className="target-room-widget" style={{
            background: C.surface,
            border: `1px solid ${C.border}`,
            borderRadius: '12px',
            padding: '16px',
...
function CourseCard({ course, today }: { course: CourseProgress; today: string }) {
  ...
  return (
    <div className="target-room-course-widget" style={{
      background: C.surface,
      border: `1px solid ${C.border}`,
      borderRadius: '12px',
      padding: '18px',
...
function CalendarView({
  ...
  return (
    <section className="target-room-section target-room-calendar-section">
      ...
      {selectedDate && (
        <div className="target-room-widget target-room-selected-date" style={{
          background: C.surface,
          border: `1px solid ${C.border}`,
          borderRadius: '12px',
          padding: '20px',
...
function ListView({ courses, manualProgress }: { courses: CourseProgress[]; manualProgress: ManualProgress }) {
  ...
  return (
    <section className="target-room-section target-room-list-section">
