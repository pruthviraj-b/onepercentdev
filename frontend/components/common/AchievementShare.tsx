...
import { achievementId, buildAchievementPost, loadAchievements, makeBadgeDataUrl, saveAchievement, AchievementRecord } from '@/features/certificates/achievements';
import { fetchNote } from '@/services/courseService';

const C = {
  bg: '#FFFFFF', surface: '#FFFFFF', surfaceHi: '#FFFFFF', border: '#E5E7EB', borderHi: '#1F2937',
  text: '#1F2937', dim: '#6B7280', cyan: '#F98012', green: '#22C55E', amber: '#F59E0B', onAccent: '#FFFFFF',
};
  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .achievement-credential-meta{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;padding:10px;border:1px solid ${C.border};border-radius:4px;background:${C.bg}}.achievement-credential-meta div{display:flex;flex-direction:column;gap:4px;min-width:0}.achievement-credential-meta span{color:${C.cyan};font:700 .56rem 'Google Sans Flex',sans-serif;letter-spacing:.08em}.achievement-credential-meta strong{color:${C.text};font-size:.68rem;line-height:1.3;overflow-wrap:anywhere}@media(max-width:680px){.achievement-credential-meta{grid-template-columns:1fr}}
