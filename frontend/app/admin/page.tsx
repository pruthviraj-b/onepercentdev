...
export default function AdminDashboard() {
  ...
  const [viewMode, setViewMode] = useState<'modules' | 'settings' | 'students'>('modules');
  ...
  return (
    <div className="admin-container">
      ...
      {/* Core Layout — Course Editor OR Students Analytics */}
      {viewMode === 'students' ? (
        <div style={{ padding: '0' }}>
          <StudentAnalyticsModule adminPassword={sessionStorage.getItem('admin_pwd') || ''} />
        </div>
      ) : (
